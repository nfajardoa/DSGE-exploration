...
% 
% mkdir CF_lineal
% copyfile('./archivos_mod/Ferroni_4.mod','CF_lineal')
...
% 
% mkdir BW_lineal
% copyfile('./archivos_mod/Ferroni_4.mod','BW_lineal')
...
% 
% mkdir LD_lineal
% copyfile('./archivos_mod/Ferroni_4.mod','LD_lineal')
...
% 
% mkdir PD_lineal
% copyfile('./archivos_mod/Ferroni_4.mod','PD_lineal')
