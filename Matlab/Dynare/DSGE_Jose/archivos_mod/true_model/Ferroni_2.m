...
erase_compiled_function('Ferroni_2_static');
erase_compiled_function('Ferroni_2_dynamic');
M_.orig_eq_nbr = 8;
M_.eq_nbr = 8;
M_.ramsey_eq_nbr = 0;
...
options_.order = 1;
var_list_ = char('gy_obs','gh_obs');
oo_recursive_=dynare_estimation(var_list_);
save('Ferroni_2_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Ferroni_2_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Ferroni_2_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Ferroni_2_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Ferroni_2_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('Ferroni_2_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('Ferroni_2_results.mat', 'oo_recursive_', '-append');
end
